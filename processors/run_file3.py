...
def run_file3(con, command_line_arg, host = 'TEST-WS000'):
	...
	src_dir = "D:\\SCAN\\DISTR\\OpenHardwareMonitor"
	dst_dir	= "C:\\Distr\\1C\\OpenHardwareMonitor"	
	#------------------------------
	run_setup_file = "cmd.exe /c C:\\Distr\\1C\\OpenHardwareMonitor\\OpenHardwareMonitor.exe"
	tmp_result = ""
	result = []
